...
class WebOSCompletionProvider {
    ...
    getWebOSServiceCompletions() {
        ...
        requestCompletion.insertText = new vscode.SnippetString(`webOS.service.request('\${1:luna://service.uri}', {
    method: '\${2:methodName}',
    parameters: {
        \${3:// parameters}
    },
    ...
    onFailure: function (inError) {
        ...
        requestCompletion.documentation = new vscode.MarkdownString('Generate a webOS TV Luna Service API call');
        completions.push(requestCompletion);
        return completions;
    }
    getServiceURICompletions() {
        const completions = [];
    ...
    async getMethodCompletions(linePrefix) {
        const completions = [];
